...
parameters.data.input_rescaling_type = "None"
parameters.data.output_rescaling_type = "None"
...
#parameters.targets.ldos_gridspacing_ev = 5.0
...
data_handler.add_snapshot(
    "Be_snapshot0.in.npy", data_path, "Be_snapshot0.out.npy", data_path, "va"
)
data_handler.prepare_data()
print('after handler',parameters.descriptors.descriptor_type)
####################
# 3. NETWORK SETUP
