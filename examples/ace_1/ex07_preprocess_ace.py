...
parameters.descriptors.ace_lmax = [0,5,2]
parameters.descriptors.ace_nmax = [5,5,2]
...
#outfile1 = os.path.join(data_path, "Be_snapshot1.out")
#ldosfile1 = os.path.join(data_path, "cubes/tmp.pp*Be_ldos.cube")
...
data_converter.add_snapshot(
    descriptor_input_type="espresso-out",
    descriptor_input_path=outfile1,
    target_input_type=".cube",
    target_input_path=ldosfile1,
    additional_info_input_type="espresso-out",
    additional_info_input_path=outfile1,
    target_units="1/(Ry*Bohr^3)",
)
"""
####################
