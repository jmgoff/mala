...
def run_prediction(backprop=False,atoms=None,pass_descriptors=None):
    ...
    #parameters.lammps_compute_file = '/home/jmgoff/Software/mala_ace_force_test/mala/descriptors'
    grd_loc = [18,18,27]
    if type(atoms) == str:
        atoms = read(atoms)
    else:
...
def pre_force_callback(lmp):
    ...
    print('mala force coeffs info:',mala_forces.shape,mala_test.shape,np.amax(mala_forces))
