...
def analytical_integration_weights(I0, I1, fermi_energy, energy_grid,
                                   temperature):
    """
    Constructs the weights used in analytical integration as described in Eq. 32 of [1].
    ...
    Returns
    -------
    weights_vector : numpy.array
        Weights to be used in the integral.
